...
const migrations = [
  ...
  "ALTER TABLE client_positioning ADD COLUMN sobre TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN historia TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN promessa_completa TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN promessa_curta TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN transformacao_narrativa TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN transformacao_procedencia TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN diferencial_1 TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN diferencial_2 TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN diferencial_3 TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN icp_quem_e TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN icp_quem_nao_e TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN icp_psicologico TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN crencas_tentou TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN crencas_nao_acredita TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN desejos_secretos TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN desejos_aspiracional TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN dores_profundas TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN dores_travando TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN objecoes_desculpas TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN objecoes_medos TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN branding_direcao TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN branding_sensacoes TEXT DEFAULT '[]'",
  "ALTER TABLE client_positioning ADD COLUMN visual_identidade_link TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_logo_url TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_logo_texto TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_cores_url TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_cores_texto TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_tipografia_url TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_tipografia_texto TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_mood_pinterest TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN visual_mood_url TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN verbal_tom TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN verbal_jargoes TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN verbal_emojis TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN proibido_design TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN proibido_imagens TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN proibido_conteudo TEXT DEFAULT ''",
  "ALTER TABLE client_positioning ADD COLUMN proibido_copys TEXT DEFAULT ''",
